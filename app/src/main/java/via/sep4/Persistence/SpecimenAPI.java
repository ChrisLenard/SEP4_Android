...
public interface SpecimenAPI {
    ...
    Call<SensorDataList> getSpecimenSensor(@Path("specimen_key") int specimen_key, @Query("datetime_from") long datetime_from,@Query("datetime_until") long datetime_until);
